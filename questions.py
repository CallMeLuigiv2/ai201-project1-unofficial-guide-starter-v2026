...
QUESTIONS = [
    ...
    {"question": "how long is the walk in elder ness to the lighthouse ", "expects": " 25 minutes"},
    {"question": "on summer weekends what time do halden bay lots tend to fill up ", "expects": "10:00 am"},
